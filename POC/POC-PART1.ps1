...
Invoke-WebRequest -Uri "https://github.com/lennyomg/Spotify-PowerShell/releases/download/1.0.66/Spotify-PowerShell-1.0.66.zip" -OutFile "c:\temp"

Expand-Archive -Path "c:\temp\Spotify-PowerShell-1.0.66.zip" -DestinationPath c:\Spotify
